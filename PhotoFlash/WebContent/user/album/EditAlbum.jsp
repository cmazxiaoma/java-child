...
<div class="ctn-960 mg shadow-5" style="background-color:white;">
  <form  action="<c:url value='/UpdateAlbumServlet'/>" class="js-form-validate" method="post" onSubmit="return checkForm()" name="f" enctype="multipart/form-data" data-arg-one="#" data-arg-two="100">
    <input type="hidden" name="aid"  value="${editAlbum.aid }"/>
          ...
          <div class="confirmationForm clearfix" style="width:100%;">
            <div id="invest-paypwd" style="width:60%;float:left">
              <ul class="agree-protocol">
                <li>
                  <label class="plain-text"><span class="td-name" style="font-weight:bolder;">名称：</span><span class="plain-text">
                    <input  type="text"  id="album"value="${editAlbum.albumname }" name="albumname" placeholder="请输入相册名称" onblur="checkalbum();" >
                    <font id="checkalbumname"></font></span></label>
				...
				<li>
                  <label class="plain-text"><span class="td-name" style="font-weight:bolder;">描述：</span><span class="plain-text">
                    <input  type="text"  name="a_description" value="${editAlbum.a_description }" placeholder="对相册进行描述" >
                    </span></label>
                  <div class="error-container error" id="form-invest-confirm-error-pass"></div>
                </li>
				<li>
                  <label class="plain-text"><span class="td-name" style="font-weight:bolder;">类型：</span><span class="plain-text">
                    <input  type="text"  name="type" value="${editAlbum.type }" placeholder="请输入相册类型" />
                    </span></label>
                  <div class="error-container error" id="form-invest-confirm-error-pass"></div>
                </li>
				<li>
                  <label class="plain-text"><span class="td-name" style="font-weight:bolder;">权限：</span>
                  
                   <select name="power">
				  
				  <option value="1"  <c:if test="${requestScope.editAlbum.power eq 1}">selected="selected"</c:if>>
                   	所有人可见
                   </option> 
                    <option value="2"  <c:if test="${requestScope.editAlbum.power eq 2 }">selected="selected"</c:if>>
                   	自己可见
                   </option>
              ...
              <div class="invest-btn-line">
                <input tabindex="3" id="confirm-btn" type="submit" value="编辑相册" class="i-p-c-i-btn clearButton">
                <span id="confirmERR" class="error" style="vertical-align:top;color:#CB282D;padding-left:20px;line-height:45px"></span> </div>
            </div>
			
			<div style="width:40%;float:right;">
		  	<img src="<c:url value='/${editAlbum.coverpath }'/>" width="250" height="250"/>
			</div>
          </div>
        </dd>
      </dl>
