...
public class Operation implements Runnable {
	...
	public Operation(String atm, CreditCardAccount myCard, int dwCash, ReadWriteLock myLock, int operationType) {
		super();
		this.atm = atm;
		this.myCard = myCard;
		this.dwCash = dwCash;
	...
	public Operation(String atm, CreditCardAccount myCard, int dwCash, ReadWriteLock myLock) {
		super();
		this.atm = atm;
		this.myCard = myCard;
		this.dwCash = dwCash;
